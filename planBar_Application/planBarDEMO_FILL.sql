...
INSERT INTO `fach` (`id`, `name`, `tag`) VALUES
(1, 'Deutsch', 'D'),
(2, 'Französisch', 'F'),
(3, 'Englisch', 'E'),
(4, 'Latein', 'L'),
...
INSERT INTO `semester` (`id`, `end_date`, `name`, `start_date`, `max_number_of_exams`, `enabled`) VALUES
(1, '2022-01-21', 'HS 2021', '2021-08-16', 5, true),
(2, '2022-08-21', 'FS 2022', '2022-01-22', 5, true);
